...
void DrawInv()
{
	...
	if (plr[myplr].InvBody[INVLOC_HEAD]._itype != ITYPE_NONE) {
		...
		if (pcursinvitem == INVITEM_HEAD) {
			...
			CelDecodeClr(colour, PANEL_RIGHT + 133, 60 + SCREEN_Y - 1, (BYTE *)pCursCels, frame, frame_width, 0, 8);
		}

		if (plr[myplr].InvBody[INVLOC_HEAD]._iStatFlag) {
			CelDrawHdrOnly(PANEL_RIGHT + 133, 60 + SCREEN_Y - 1, (BYTE *)pCursCels, frame, frame_width, 0, 8);
		} else {
			CelDrawHdrLightRed(PANEL_RIGHT + 133, 60 + SCREEN_Y - 1, (BYTE *)pCursCels, frame, frame_width, 0, 8, 1);
		}
	}
	...
	if (plr[myplr].InvBody[INVLOC_RING_LEFT]._itype != ITYPE_NONE) {
		...
		if (pcursinvitem == INVITEM_RING_LEFT) {
			...
			CelDecodeClr(colour, PANEL_RIGHT + 48, 205 + SCREEN_Y, (BYTE *)pCursCels, frame, frame_width, 0, 8);
		}

		if (plr[myplr].InvBody[INVLOC_RING_LEFT]._iStatFlag) {
			CelDrawHdrOnly(PANEL_RIGHT + 48, 205 + SCREEN_Y, (BYTE *)pCursCels, frame, frame_width, 0, 8);
		} else {
			CelDrawHdrLightRed(PANEL_RIGHT + 48, 205 + SCREEN_Y, (BYTE *)pCursCels, frame, frame_width, 0, 8, 1);
		}
	}
	...
	if (plr[myplr].InvBody[INVLOC_RING_RIGHT]._itype != ITYPE_NONE) {
		...
		if (pcursinvitem == INVITEM_RING_RIGHT) {
			...
			CelDecodeClr(colour, PANEL_RIGHT + 249, 205 + SCREEN_Y, (BYTE *)pCursCels, frame, frame_width, 0, 8);
		}

		if (plr[myplr].InvBody[INVLOC_RING_RIGHT]._iStatFlag) {
			CelDrawHdrOnly(PANEL_RIGHT + 249, 205 + SCREEN_Y, (BYTE *)pCursCels, frame, frame_width, 0, 8);
		} else {
			CelDrawHdrLightRed(PANEL_RIGHT + 249, 205 + SCREEN_Y, (BYTE *)pCursCels, frame, frame_width, 0, 8, 1);
		}
	}
	...
	if (plr[myplr].InvBody[INVLOC_AMULET]._itype != ITYPE_NONE) {
		...
		if (pcursinvitem == INVITEM_AMULET) {
			...
			CelDecodeClr(colour, PANEL_RIGHT + 205, 60 + SCREEN_Y, (BYTE *)pCursCels, frame, frame_width, 0, 8);
		}

		if (plr[myplr].InvBody[INVLOC_AMULET]._iStatFlag) {
			CelDrawHdrOnly(PANEL_RIGHT + 205, 60 + SCREEN_Y, (BYTE *)pCursCels, frame, frame_width, 0, 8);
		} else {
			CelDrawHdrLightRed(PANEL_RIGHT + 205, 60 + SCREEN_Y, (BYTE *)pCursCels, frame, frame_width, 0, 8, 1);
		}
	}
	...
	if (plr[myplr].InvBody[INVLOC_CHEST]._itype != ITYPE_NONE) {
		...
		if (pcursinvitem == INVITEM_CHEST) {
			...
			CelDecodeClr(colour, PANEL_RIGHT + 133, 160 + SCREEN_Y, (BYTE *)pCursCels, frame, frame_width, 0, 8);
		}

		if (plr[myplr].InvBody[INVLOC_CHEST]._iStatFlag) {
			CelDrawHdrOnly(PANEL_RIGHT + 133, 160 + SCREEN_Y, (BYTE *)pCursCels, frame, frame_width, 0, 8);
		} else {
			CelDrawHdrLightRed(PANEL_RIGHT + 133, 160 + SCREEN_Y, (BYTE *)pCursCels, frame, frame_width, 0, 8, 1);
		}
	}
